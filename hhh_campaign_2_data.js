  ...
  levels: [
    ...
    // every node advances toward that source's clue.
    {
      ...
      explanation: {
        ...
        funFact: "Authenticating documents is a real science with a name: diplomatics, founded in 1681 when Jean Mabillon published rules for telling genuine charters from forgeries. Modern examiners weigh many signs together — materials and ink, handwriting, provenance, chain of custody, and whether independent records corroborate a document's story. Unexplained neatness can prompt a closer look, but no single surface feature proves a record genuine or forged: real working documents can be clean, and good forgeries can fake corrections. It is the whole chain of evidence that convicts — which is exactly how you caught this one.",
      },
    },
    ...
    // ════════════════════════════════════════════════════════════════════
    {
        ...
        // ── 2 · The Failing Soil Zone (unlocks on Nova; the physical science + the fungal reader) ──
        {
          ...
          sources: {
            ...
            mycorrhizal: {
              ...
              learned: "A TAA scan of the terrace edge finds the cause the surface hides. \n\nThe First Garden's mycorrhizal network — a web of fungal threads the restoration cultivated into one continuous system, carrying water, nutrients, and chemical signal between plants across the whole slope — has been cleanly SEVERED between the thriving zone and the failing one. \n\nThe soil isn't diseased or drained. Its connections have been cut, leaving each terrace an island. This garden's soil was made a single network, and it was carved into pieces. This is what unlocks the summit pavilion.",
              nodes: {
                start: {
            ...
            kess: {
              ...
              nodes: {
                ...
                names: {
                  text: "\"Beneath most living ground run fungal threads — mycorrhizae — laced to the roots they feed and are fed by. How much passes onward, plant to plant, differs soil to soil; even your own scientists still argue how far the sharing reaches in the wild. But this garden was not left to chance. Its restorers wove the web whole on purpose — one continuous network, raised to trade water and food and warning across the entire slope. One web, feeding many. It is how this soil was taught to be generous. Here, the web is cut. Clean, between this terrace and the next. Each side hoards what little it has and cannot share.\n\nAnd it can be healed. Take a graft of living, connected soil from the mature ground and work it into the broken zones. The web reaches for itself. It wants to reconnect.\"",
      ...
      explanation: {
        title: 'The Record Validates',
        body: "The living diagnosis holds. Beneath Nova's garden ran a mycorrhizal network unlike any wild ground's: a web of fungal threads laced between the roots of every plant, cultivated by the restoration into one continuous system carrying water, nutrients, and chemical signal across the whole slope. One web, feeding many — by design. (In wild soils the root-and-fungus partnership is ancient and nearly everywhere, but how much actually travels between plants through shared networks varies from system to system, and scientists still debate how far it goes. The First Garden built the certainty its stewards wanted.) The web had been severed clean between the thriving terraces and the failing ones, leaving each an island that could not share what it had. And the fix was a graft of connected soil from mature ground, and the web reaches for itself and reconnects. \n\nThe forgery did not argue with any of that. It simply wrote FAILED over the top of it, in real time. No fix found, alien methods incompatible, the decline natural.\n\nEvery thread before this was already cut and cold by the time you arrived. \n\nBut the thread does not end here. It turns, and points at the source of the forgeries.",
        funFact: "When the first plants crept from water onto bare rock — likely more than 450 million years ago, a date scientists infer rather than observe — they probably did not do it alone. The oldest direct proof is younger: in plants preserved in fine detail from about 407 million years ago, fungal threads run inside the tissue itself — the ancestors of today's mycorrhizae, caught mid-partnership in stone. Everything earlier rests on inference: fossil spores that look fungal, chemistry, and the family trees of living species. The early plants had no true roots to mine the barren ground for water and minerals; the fungi could not make sugar from sunlight. Each did for the other what it could not do for itself, and together they made land livable. Nearly every plant lineage that followed — forests, grasslands, and the crops in every field you have walked — inherited that partnership, and most still depend on it: a mesh so fine that a single teaspoon of healthy soil can hold kilometres of fungal thread. Life did not colonize the land as separate species. It crossed the boundary together, root laced to thread. Nova's garden is invented; the partnership beneath it is older than trees.",
      },
    },
